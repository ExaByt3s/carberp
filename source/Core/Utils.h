...
namespace Directory
{
	//очистка папка вместе с подпапками, если delFolder = true, то удаляет и саму переданную папку, содержимое удаляется безвозратно (в корзину ничего не перемещается)
